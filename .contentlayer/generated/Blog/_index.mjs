...
export const allBlogs = [automatingRepetitiveTasksProductivityHacksForDevelopers__indexMdx, bestPracticesForWritingCleanAndMaintainableCode__indexMdx, masteringCssGridLayout__indexMdx, buildingProgressiveWebAppsBridgingTheGapBetweenWebAndMobile__indexMdx, mindfulnessAndMeditationTechniquesForDevelopersImprovingFocusAndClarity__indexMdx, jsFrameworksComparison__indexMdx, progressiveWebAppsPwa__indexMdx, restfulApisBuildingBlocks__indexMdx, webAccessibilityBestPractices__indexMdx, webAccessibilityInclusiveDesign__indexMdx, webDevelopmentToolsProductivity__indexMdx]
